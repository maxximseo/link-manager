...
function renderActivePlacements(placements) {
    ...
    if (placements.length === 0) {
        tbody.innerHTML = '<tr><td colspan="11" class="text-center text-muted">Нет активных размещений</td></tr>';
...
async function loadScheduledPlacements() {
    try {
        ...
        document.getElementById('scheduledPlacementsTable').innerHTML =
            '<tr><td colspan="10" class="text-center text-danger">Ошибка загрузки</td></tr>';
    }
}
